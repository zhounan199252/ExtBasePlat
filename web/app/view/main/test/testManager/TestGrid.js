Ext.define('ExtFrame.view.main.test.testManager.TestGrid', {
    ...
    initComponent: function () {
        ...
        me.columns = [
            ...
            { text: '姓名', dataIndex: 'name', searchable: true, fieldType: 'string' },
            { text: '年龄', dataIndex: 'age', searchable: true, fieldType: 'string' },
        ...
        //构造grid store
        me.store = Ext.create('ExtFrame.store.Test', {
            pageSize: pageSize,
            remoteSort: true,
            sortOnLoad: true,
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath()+"/myTest/pagedQueryByBean.do",
                reader: {
                    type: 'json',
