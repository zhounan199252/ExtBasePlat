Ext.define('ExtFrame.view.main.sys.buttonsManager.ButtonsGrid', {
    ...
    initComponent: function () {
        ...
        */
        me.columns = [
             //{ text: 'OID', dataIndex: 'OID', searchable: true, fieldType: 'string' },
             { text: '名称', dataIndex: 'name', searchable: true, fieldType: 'string' },
             { text: '英文名称', dataIndex: 'ename', searchable: true, fieldType: 'string' },
             { text: '描述', dataIndex: 'description', width: 220 },
             { text: '排序', dataIndex: 'sortCode', searchable: true },
             {
        ...
        me.store = Ext.create('ExtFrame.store.Buttons', {
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath()+"/buttons/getButtonsList.do",
                reader: {
                    type: 'json',
