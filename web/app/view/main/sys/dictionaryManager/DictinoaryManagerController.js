Ext.define('ExtFrame.view.main.sys.dictionaryManager.DictinoaryManagerController', {
    ...
    onClickButtonSave: function () {
        ...
        if (form.isValid()) {
           ...
           // var data = Tools.Method.GetPostData(Ext.encode(record));
            if (record) {
                store.removeAll();
                Tools.Method.ExtAjaxRequestEncap(Tools.Method.getAPiRootPath() + '/dictionary/postSave.do', 'POST', record, true, function (jsonData) {
                    if (jsonData) {
    ...
    onClickButtonDel: function () {
        Tools.GridSearchToolbar.DeleteByOIDEncap(this, Tools.Method.getAPiRootPath() + '/dictionary/deleteById.do');
    },
