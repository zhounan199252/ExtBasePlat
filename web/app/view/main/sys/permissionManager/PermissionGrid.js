Ext.define('ExtFrame.view.main.sys.permissionManager.PermissionGrid', {
    ...
    initComponent: function () {
        ...
        */
        me.columns = [
             ...
             { text: '描述', dataIndex: 'description', searchable: true, fieldType: 'string', width: 220 },
             { text: '创建时间', dataIndex: 'createTime', width: 220 }
        ];
        //构造grid store
        me.store = Ext.create('ExtFrame.store.Permission', {
            pageSize: pageSize,
            remoteSort: true,
            sortOnLoad: true,
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath() + "/permissonInfo/getAllPermissionList.do",
                reader: {
                    type: 'json',
