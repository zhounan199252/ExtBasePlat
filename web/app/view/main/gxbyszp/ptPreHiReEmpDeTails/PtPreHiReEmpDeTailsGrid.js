Ext.define('ExtFrame.view.main.gxbyszp.ptPreHiReEmpDeTails.PtPreHiReEmpDeTailsGrid',{
    extend:'Ext.grid.GridPanel',
    alias:'widget.ptPreHiReEmpDeTailsGrid',
    fit:true,
    stripeRows:true,
    initComponent:function(){
        ...
        var OrderField = 'empName';//默认排序字段
        var OrderType = 'DESC';//默认排序类型 ASC/DESC
        var OrderField2 = 'rptPerson';
        /*
         ** grid控件绑定列
        ...
        me.columns=[
            ...
            { text: '审批状态',  dataIndex:'isAudit',locked:true,fieldType: 'string'},
            { text: '姓名', dataIndex: 'empName', locked:true,searchable: true, fieldType: 'string' },
            { text: '性别', dataIndex: 'genDer',  fieldType: 'string' },
            { text: '专业名称', dataIndex: 'specName', fieldType: 'string'},
            { text: '学历', dataIndex: 'eduBg',fieldType:'string' },
            { text: '毕业时间',  dataIndex:'gradDate', fieldType: 'Date'},
            { text: '毕业院校', dataIndex: 'gradUniv', fieldType: 'string' },
            { text: '培养方式', dataIndex: 'trainMethod',  fieldType: 'string' },
            { text: '用人单位', dataIndex: 'unit', searchable: true,fieldType: 'string'},
            { text: '业务群名称', dataIndex: 'buSiGroup',fieldType:'string' },
            { text: '录用级别', dataIndex: 'enRollLevel',fieldType:'string' }
        ];
        //构造grid store
        me.store=Ext.create('ExtFrame.store.PtPreHiReEmpDeTails',{
            ...
            proxy: {
                type: 'ajax',
                url: Tools.Method.getAPiRootPath()+"/ptPreHiReEmpDeTails/pagedQueryByBean.do",
                reader: {
                    type: 'json',
                    rootProperty: 'extData',//数据根节点名称
                    totalProerty: 'total',//数据总数节点名称
                    idProperty: 'ptPreHiReEmpDeTailsGrid'//id标示节点名称
                },
                //扩展参数
                extraParams: {
                    'swhere': ""
