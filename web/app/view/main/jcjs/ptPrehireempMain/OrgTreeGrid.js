Ext.define('ExtFrame.view.main.jcjs.ptPrehireempMain.OrgTreeGrid', {
    ...
    listeners:{
        selectionchange: function (me, selected, eOpts) {
            ...
            if (selected.length == 1) {
                Tools.Method.ExtAjaxRequestEncap(Tools.Method.getAPiRootPath()+'/baseOrgInfo/getOrg.do?orgId=' + selected[0].data.oid, 'GET', null, true, function (jsonData) {
