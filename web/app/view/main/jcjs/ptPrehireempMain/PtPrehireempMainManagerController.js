Ext.define('ExtFrame.view.main.jcjs.omWorkType.OmWorkTypeManagerController', {
    ...
    onClickButtonSave: function () {
        Tools.GridSearchToolbar.SaveEncap(this, Tools.Method.getAPiRootPath()+'/ptPrehireempMain/save.do');
    },
    onClickButtonDel: function () {
        Tools.GridSearchToolbar.DeleteByOIDEncap(this, Tools.Method.getAPiRootPath()+'/ptPrehireempMain/delete.do');
    },
