...
import com.pmcc.core.manager.OmWorkTypeManager;
...
public class OmWorkTypeController extends BaseAjaxController<OmWorkType, String> {
    @Autowired
    OmWorkTypeManager workTypeManager;

    @Override
    public String beforeSave(OmWorkType model, HttpServletRequest request){
